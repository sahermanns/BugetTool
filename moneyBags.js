...
function annualSave() {
  answer = $('#showSavings').html() * 12;
  console.log($('#showSavings').html() * 12);
  $('#annualSave').html(input * 12);
  input = Number($('#showSavings').val());
}

function monthlySave() {
  answer = $('#showSavings').html();
  console.log($('#showSavings').html());
  $('#monthlySave').html(input);
  input = Number($('#showSavings').val());
}
